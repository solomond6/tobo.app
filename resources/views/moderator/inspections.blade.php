          ...
          <div class="table-responsive">
            <form method="post" action="/admin/">
              <div class="form-group row">
                  <div class="col-12">
                      <textarea class="form-control" name="cooment" placeholder="Comment"></textarea>
                      <input class="form-control" type="hidden" name="id" value="3" required="required">
                      <select class="form-control" name="Status"><option value="1">Approved</option></select>
                  </div>
              </div>
            </form>
  ...
  var dt = $('.users-table').DataTable({
              ...
              responsive: true,
                ...
                [
                  ...
                  { className: 'dt-control',data: 'agent_name', name: 'agent_name' },
                  { className: 'dt-control',data: 'fullname', name: 'fullname' },
                  { className: 'dt-control',data: 'email', name: 'email' },
                  { className: 'dt-control',data: 'phone_no', name: 'phone_no' },
                  { className: 'dt-control',data: 'country', name: 'country' },
                  { className: 'dt-control',data: 'no_of_people', name: 'no_of_people' },
                  { className: 'dt-control',data: 'budget', name: 'budget' },
                  { className: 'dt-control',data: 'status', name: 'status' },
                  { className: 'dt-control',data: 'created_at', name: 'created_at' },
